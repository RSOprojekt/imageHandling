package si.fri.rso.imagehandling.api.v1.interceptors;
...
public class LogContextInterceptor {
    ...
    public Object logMethodEntryAndExit(InvocationContext context) throws Exception{
        ...
        //TODO handle requests across microservices so that they have a unique Id ... see video
        settings.put("uiqueRequestId", UUID.randomUUID().toString());
